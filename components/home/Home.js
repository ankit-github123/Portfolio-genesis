        ...
        <div className='relative'>
            <div className="h-20 flex items-center w-full justify-between">
                <div className="flex gap-1.5 w-max items-center">
                    <img src="/images/common/logo.svg" className='w-14' alt="Protfolio genesis" />
                ...
                <div className='grid grid-cols-9'>
                    <div className='col-span-5'>
                        <div className='pr-[6%] text-center'>
                            <div className='text-4xl md:leading-snug md:text-[50px] md:font-semibold'>Build your own<br /> <span className='home-title-gradient text-[54px] font-bold font-opensans'>Personalised portfolio</span></div>
                            {/* <div className='text-home text-start'>-No Code Required</div> */}
                            <div className='md:leading-relaxed text-[17px] my-6 opacity-70'>
                                Welcome to Portfolio Genesis, your gateway to effortlessly craft a stunning personal portfolio website without the need for a single line of code.
                            </div>
                            <div className='my-7'>
                                {session?.user && <button onClick={signOut} className="pulse-button">Get started</button>}
                            </div>
                        </div>
                    </div>
                    <div className='col-span-8 md:col-span-4'>
                        <div className='my-3'>
                            <video height="800" className='w-full border border-[rgba(255,255,255,0.05)] rounded-lg' autoPlay loop muted>
